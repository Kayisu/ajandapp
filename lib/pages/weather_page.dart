...
import 'package:todoapp/util/weather.dart';
...
class _WeatherHomeState extends State<WeatherHome> {
  ...
  myWeather() {
    isLoading = false;
    // Replace 'yourCityName' with the appropriate argument required by fetchWeather
    WeatherServices().fetchWeather('Kayseri').then((value) {
      setState(() {
        weatherInfo = value;
        isLoading = true;
      });
